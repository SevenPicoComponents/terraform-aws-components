locals {
  transit_gateway_id = var.existing_transit_gateway_id != null && var.existing_transit_gateway_id != "" ? var.existing_transit_gateway_id : (
    module.context.enabled && var.create_transit_gateway ? aws_ec2_transit_gateway.default[0].id : null
  )
  transit_gateway_route_table_id = var.existing_transit_gateway_route_table_id != null && var.existing_transit_gateway_route_table_id != "" ? var.existing_transit_gateway_route_table_id : (
    module.context.enabled && var.create_transit_gateway_route_table ? aws_ec2_transit_gateway_route_table.default[0].id : null
  )
  ...
  lookup_transit_gateway = module.context.enabled && ((var.existing_transit_gateway_id != null && var.existing_transit_gateway_id != "") || var.create_transit_gateway)
}

resource "aws_ec2_transit_gateway" "default" {
  count                              = module.context.enabled && var.create_transit_gateway ? 1 : 0
  description                        = var.transit_gateway_description == "" ? format("%s Transit Gateway", module.context.id) : var.transit_gateway_description
...
resource "aws_ec2_transit_gateway_route_table" "default" {
  count              = module.context.enabled && var.create_transit_gateway_route_table ? 1 : 0
...
data "aws_vpc" "default" {
  for_each = module.context.enabled && var.create_transit_gateway_vpc_attachment && var.config != null ? var.config : {}
...
resource "aws_ec2_transit_gateway_route_table_association" "default" {
  for_each                       = module.context.enabled && var.create_transit_gateway_route_table_association_and_propagation && var.config != null ? var.config : {}

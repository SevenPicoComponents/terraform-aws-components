...
locals {
  ...
  input = {
    ...
    project     = var.project == null ? lookup(var.context, "project", null) : var.project
    region      = var.region == null ? lookup(var.context, "region", null) : var.region
  ...
  string_label_names = ["namespace", "tenant", "environment", "stage", "name", "project", "region"]
